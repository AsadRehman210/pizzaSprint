...
//   const toggleDropdown = (dealIndex) => {
...
//             {dealItem.isSelectable ? (
//               // Dropdown version for selectable items
//               <div className="relative">
//                 <div
//                   className="flex justify-between items-center border border-gray-300 rounded p-3 cursor-pointer"
//                   onClick={() => toggleDropdown(dealIndex)}
//                 >
//                   <span className="text-sm font-medium font-poppins">
//                     {selectedDealItem?.name || "Select an option"}
//                   </span>
//                   <svg
//                     className={`w-4 h-4 transition-transform ${
//                       dropdownOpen[dealIndex] ? "transform rotate-180" : ""
//                     }`}
//                     fill="none"
//                     stroke="currentColor"
//                     viewBox="0 0 24 24"
...
//               </div>
//             ) : (
//               // Original non-selectable version
//               <ul className="flex flex-col gap-2">
//                 {dealItem.selectableItems.map((item, index) => (
//                   <li key={index} className="flex items-center gap-4">
//                     <input
...
//                       checked={true}
//                       disabled={true}
//                       className="appearance-none bg-gray-200 border-gray-300 border rounded-full w-4 h-4 focus:outline-none"
//                     />
//                     <label
//                       htmlFor={`deal-${dealIndex}-${index}`}
//                       className="flex justify-between w-full"
